Shader "Raymarch/DisplacedMultiSphereContainer"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            sampler2D _MainTex;
            float4 _MainTex_ST;
            float4 _FresnelColor1, _FresnelColor2, _OuterColor;
            ...
            fixed4 frag (v2f i) : SV_Target
            {
            	...
            	float4 m = getFresnel(i.normal, i.viewDir);
            	float4 col = m;
                ...
                float4 outer = m * _OuterColor;
                return col = lerp(col, outer, m);
            }
            ENDCG
        }
    }
