Shader "Raymarch/NoiseSphere"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 _MainTex_ST;
            float _SphereRadius;
            float _NoiseStrength, _NoiseScale, _NoiseSpeed;
			...
			{
            	return sphere(p, _SphereRadius -_NoiseStrength * noise(_NoiseScale*p+3.));
    			return sdBox(p,float3(0.15, 0.15, 0.15))-.2*noise(8.*p+3.);
			}
