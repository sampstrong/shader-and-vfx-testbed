Shader "Raymarch/OrbsEnvironmentLighting"
{
    Properties
    {
    	...
    	_HazeMaxDist ("Haze Max Distance", Range(10, 100)) = 65.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                fixed4 envColor = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_CameraOpaqueTexture, UNITY_PROJ_COORD(invertedScreenPos));
                ...
                if (d.w < MAX_DIST)
                {
                	...
                	// env lighting - need to look into best way to bend color along normals
                	// fixed3 e = reflect(envColor, n);
                	// l += e;
